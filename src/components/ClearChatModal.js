      ...
      <div className="relative glass-modal border border-white/20 rounded-2xl max-w-sm mx-4 w-full">
        <div className="p-6">
          <div className="flex items-center mb-4">
            <div className="w-10 h-10 glass-button-danger rounded-full flex items-center justify-center mr-3">
              <svg
          ...
          <div className="flex space-x-3">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2.5 glass-button text-gray-300 hover:text-white rounded-xl text-sm font-medium cursor-pointer"
            >
              Cancel
            </button>
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2.5 glass-button-danger text-white rounded-xl text-sm font-medium cursor-pointer"
            >
              Clear All
            </button>
          </div>
